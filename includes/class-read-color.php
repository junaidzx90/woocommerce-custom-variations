...
class ColorInterpreter {
    ...
    public function hsl($color) {
        $rgb = array(
            intval($this->hexdecs(substr($color, 1, 2))) / 255, 
            intval($this->hexdecs(substr($color, 3, 2))) / 255, 
            intval($this->hexdecs(substr($color, 5, 7))) / 255
        );
    ...
    public function rgb($color) {
        return array(
            $this->hexdecs(substr($color, 1, 2)), 
            $this->hexdecs(substr($color, 3, 2)),  
            $this->hexdecs(substr($color, 5, 7))
        );
    }
